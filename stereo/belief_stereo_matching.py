...
# https://github.com/alexprz/StereoMatching
###

save_path = './belief_images'
...
parser.add_argument('--disparity_image', '-o', default = './belief_images/belief_tsukuba.png', type=str, help='disparity image path')
args = parser.parse_args()



# matching cost computation, truncated absolute intensity
...
def stereo_bp(I1,I2,num_disp_values,Lambda,Tau=15,num_iterations=60):
    """The main function"""
    dataCost = compute_data_cost(I1, I2, num_disp_values, Tau) # matching cost computation
...
# Input
img_left =imageio.imread(args.left_image)
img_right=imageio.imread(args.right_image)
# plt.subplot(121)
# plt.imshow(img_left)
# plt.subplot(122)
...
imageio.imwrite(args.disparity_image, disparity)
...
plt.plot(energy)
plt.savefig(os.path.join(save_path, 'belief_energy.png'))